...
if __name__ == "__main__":
    ...
    if conn:
        ...
        # # # Example usage
        # specific_date = '2020-09-26'  # Date for the query
        # min_lat = -119.6599             # Replace with minimum latitude of bounding box
        # max_lat = 34.3281            # Replace with maximum latitude of bounding box
        # min_lon = -118.4258           # Replace with minimum longitude of bounding box
        # max_lon = -11243           # Replace with maximum longitude of bounding box
